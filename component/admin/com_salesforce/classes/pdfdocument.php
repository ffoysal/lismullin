...
if (!class_exists('TCPDF')) {
   require_once JPATH_ADMINISTRATOR.DS.'components'.DS.'com_salesforce'.DS.'classes'.DS.'tcpdf'.DS.'config'.DS.'lang'.DS.'ger.php';
   require_once JPATH_ADMINISTRATOR.DS.'components'.DS.'com_salesforce'.DS.'classes'.DS.'tcpdf'.DS.'tcpdf.php';
}
require_once JPATH_ADMINISTRATOR.DS.'components'.DS.'com_salesforce'.DS.'classes'.DS.'fpdi'.DS.'fpdi.php';
...
class PdfInvoice extends PdfDocument
{
	...
	{
		if (!empty($this->_file)) return false;
		$this->_file = $name;
		$this->Output($name, 'F');
		return true;
	}
...
class PdfAttList extends PdfDocument
{
	public function __construct($template, $data, $attendees)
	{
		...
		include_once JPATH_ADMINISTRATOR.DS.'components'.DS.'com_salesforce'.DS.'classes'.DS.'simple_html_dom.php';
