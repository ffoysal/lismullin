...
<span ng-show="{{cor.showFullyBookedText}}">Not Available</span>  <i ng-show='{{cor.showFullyBookedText}}' class="fa fa-info-circle fully-booked-info" title='This course is now fully booked. Ring the Lismullin Office for further information.'></i>
				</td>
			  </tr>				
			</tbody>
		</table>
